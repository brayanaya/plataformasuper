export default function QuienesSomos() {
  ...
  return (
    <section id="quienes-somos" className="bg-gray-100 py-16 px-4 md:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center mb-12">
          ...
          <div className="flex-1 grid grid-cols-2 gap-4">
            {valores.map((v, i) => (
              <div key={i} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-200 hover:shadow-md hover:border-red-200 transition">
