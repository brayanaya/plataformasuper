        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col gap-2">
              ...
              <p className="text-gray-600 text-sm">Cra 52 No. 26a-03, Barrio Olaya Herrera, Neiva, Huila</p>
            ...
            <a href="https://wa.me/573226937375" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white font-bold px-6 py-4 rounded-2xl text-center hover:bg-green-400 transition">Escribenos por WhatsApp</a>
          </div>
