        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-10 border-b border-gray-800">
          <div className="md:col-span-1 flex flex-col gap-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Tu supermercado de confianza en Neiva, Huila. Precios bajos y calidad garantizada.
            </p>
            <a href="https://wa.me/573226937375" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white font-bold px-4 py-2.5 rounded-full text-center hover:bg-green-400 transition text-sm">
