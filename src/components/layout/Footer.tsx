      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col gap-4">
          <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-gray-700 flex-shrink-0">
            <img src="/logo.png" alt="La Economia Aya" className="w-full h-full object-contain" />
          </div>
        ...
        <div>
          ...
          <a href="https://wa.me/573226937375" target="_blank" className="mt-3 inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 transition text-white text-xs font-bold px-3 py-1.5 rounded-full">
