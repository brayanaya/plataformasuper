        ...
        <div className="p-4 h-full flex flex-col">
          {items.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center gap-4">
              <p className="text-gray-600 text-sm">No tienes productos. Agrega algo del catalogo!</p>
          ...
          {items.length > 0 && (
            <div className="border-t pt-4 mt-2">
              ...
              <button onClick={() => setCheckoutOpen(true)} className="w-full bg-red-700 text-white font-bold py-3 rounded-full hover:bg-red-600 transition">Finalizar Pedido</button>
            </div>
          )}
        </div>
      </div>
