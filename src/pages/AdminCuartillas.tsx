          ...
          {cuartillas.map((c) => (
            <div key={c.id} className="bg-white rounded-2xl shadow-md overflow-hidden">
              ...
              <div className="p-4 flex flex-col gap-3">
                ...
                {c.precio_oferta && <p className="text-red-700 font-extrabold"></p>}
                <div className="flex gap-2">
                  ...
                  <button onClick={() => handleEliminar(c.id, c.imagen_url)} className="flex-1 text-xs font-bold py-2 rounded-full bg-red-100 text-red-700 hover:bg-red-200 transition">
                    Eliminar
                  </button>
                </div>
              </div>
